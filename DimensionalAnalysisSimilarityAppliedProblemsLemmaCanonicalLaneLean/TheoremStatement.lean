import DimensionalAnalysisSimilarityAppliedProblemsLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String := "dimensional-analysis-similarity-applied-problems-lemma-canonical-lane"
def sourceDescription : String := "Dimensional Analysis Similarity Applied Problems Lemma"

structure SourceTheoremBoundary where
  claimBoundary : String
  
def sourceTheoremBoundary : SourceTheoremBoundary := {
  claimBoundary := "classical similarity boundary remains open"
}
